...
/**
 * This is the interface specifying how a SchedulingPolicy can interact with
 * Scheduler. This interface must be implemented inside a scheduler as inner
 * class.
 *
 * @author Piero Dalle Pezze
 * @version 1.2
...
interface ProcessDispatcherInterface {
	 ...
	 * be extracted from the ready queue. This method must be called by
	 * preemptive scheduling policies inside the method insert() if the there is
	 * the preemption of the pcbCurrent.
	 */
	 ...
	 * the current process. This method must be called by time sharing
	 * scheduling policies inside the method execute() when the quantum is
	 * elapsed.
	 */
