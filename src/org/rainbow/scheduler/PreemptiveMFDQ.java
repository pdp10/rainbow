 ...
 * view, it has a dynamic quantum each times it is added to the ready queue.
 * This variant is preemptive. On details: <br/>
 * <ul>
 ...
 * @version 1.2
 */
public class PreemptiveMFDQ extends PreemptiveMF {
	 ...
	 */
	public PreemptiveMFDQ(int timeSlice, int level) {
	...
	public State execute(int time) {
		...
		if (getTick() == getDynamicTimeSlice()
	...
	public String toString() {
		return "Preemptive Multilevel Feedback Dynamic Quantum";
	}
