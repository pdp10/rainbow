 ...
 * <li>Waiting time</li>
 * </ul>
 * Therefore it shows the following statistics of the simulation:
...
public class ViewStatistics extends JScrollPane {
	...
	public ViewStatistics() {
		...
		panelStatSimulation.add(new javax.swing.JLabel(Language
				.getStatisticsOfTheSimulation()
				+ ":\n"), BorderLayout.NORTH);
		...
		panelStatProcesses.add(new javax.swing.JLabel(Language
				.getStatisticsOfProcesses()
				+ ":\n"), BorderLayout.NORTH);
