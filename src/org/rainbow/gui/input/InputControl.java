...
public class InputControl {
     ...
     * @return true if an error is found in preemptive resource's data, false otherwise.
     */    
     ...
     * @return true if an error is found in non-preemptive resource's data, false otherwise.
     */       
     ...
     * @return true if an error is found in the duration of request, false otherwise.
     */       
