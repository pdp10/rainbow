...
public final class Language {
    ...
    private static String language, english = "English", italian = "Italian",
            ...
            indonesia = "Indonesia", persian = "Persian", esperanto = "Esperanto";
	...
	/** Private Constructor. Only the class Language can create these instances. */
    ...
    private static final LanguageItem[] languageContainer = {
      ...
      new LanguageItem(swedish, "se"),   	
      new LanguageItem(finnish, "fi"),   
      new LanguageItem(danish, "dk"),         
      new LanguageItem(russian, "ru"),         
      new LanguageItem(ukrainian, "ua"),         
      new LanguageItem(polish, "pl"),         
      new LanguageItem(greek, "gr"),         
      new LanguageItem(japanese, "jp"),   
      new LanguageItem(korean, "kr"),         
      new LanguageItem(chineseSimp, "cn"),         
      new LanguageItem(chineseTrad, "cn"),         
      new LanguageItem(arabic, "sa"),         
      new LanguageItem(hungarian, "hu"),         
      new LanguageItem(indonesia, "mc"),   
      new LanguageItem(persian, "ir"),         
      new LanguageItem(esperanto, "esp")       
    };
      
   
    public static final LanguageItem[] getLanguages() { return languageContainer; }
    
   
   
    /**
     * It initializes the chosen language. </br>
    ...
    public static boolean setLanguage(String newLanguage) {
        ...
        String path = "language/", xmlFile = path + languageContainer[0].getName().toLowerCase() + ".xml", xmlLanguageFile = path + "languageNames.xml";
        ...
        if (!defaultLanguage) {
            ...
            try {
                ...
                .item(9).getAttributes().getNamedItem(
                        "deadlockSimulationTerminated").getNodeValue();
                ...
                .item(11).getAttributes().getNamedItem(
                        "graphOfResourcesAssignment").getNodeValue();
                graphOfRunningProcesses = doc.getElementsByTagName("word")
                .item(12).getAttributes().getNamedItem(
                        "graphOfRunningProcesses").getNodeValue();
                ...
                .item(22).getAttributes().getNamedItem(
                        "simulationAtInitialState").getNodeValue();
                ...
                .getNodeValue();
                statisticsOfProcesses = doc.getElementsByTagName("word").item(
                        26).getAttributes().getNamedItem(
                        "statisticsOfProcesses").getNodeValue();
                statisticsOfTheSimulation = doc.getElementsByTagName("word")
                .item(27).getAttributes().getNamedItem(
                        "statisticsOfTheSimulation").getNodeValue();
                ...
                .item(38).getAttributes().getNamedItem(
                        "configurationSummary").getNodeValue();
                ...
                .item(49).getAttributes().getNamedItem(
                        "loadSavedConfigurationTT").getNodeValue();
                modifyConfigurationTT = doc.getElementsByTagName("word").item(
                        50).getAttributes().getNamedItem(
                        "modifyConfigurationTT").getNodeValue();
                ...
                .item(54).getAttributes().getNamedItem(
                        "moveToInitialStateTT").getNodeValue();
                ...
                .item(57).getAttributes().getNamedItem(
                        "playAutomaticAdvancementTT").getNodeValue();
                ...
                .item(59).getAttributes().getNamedItem(
                        "setDelaySimulationTT").getNodeValue();
                stopAutomaticAdvancementTT = doc.getElementsByTagName("word")
                .item(60).getAttributes().getNamedItem(
                        "stopAutomaticAdvancementTT").getNodeValue();
                /* Messages and errors */
                ...
                .item(70).getAttributes().getNamedItem(
                        "chooseTheSchedulingPolicy").getNodeValue();
                ...
                .item(98).getAttributes().getNamedItem(
                        "onlyForTimeSharingPoliciesTT").getNodeValue();
                ...
                .getAttributes().getNamedItem("ER010")
                .getNodeValue();
                error = doc.getElementsByTagName("word").item(112)
                .getAttributes().getNamedItem("error")
                .getNodeValue();
                ...
                .getAttributes().getNamedItem("themes")
                .getNodeValue();
                lookAndFeelTT = doc.getElementsByTagName("word").item(116)
                .getAttributes().getNamedItem("lafTT")
                .getNodeValue();        
                ...
                .getAttributes().getNamedItem("dutch")
                .getNodeValue();
                ...
                .getAttributes().getNamedItem("swedish")
                .getNodeValue();
                finnish = doc.getElementsByTagName("language").item(9)
                .getAttributes().getNamedItem("finnish")
                .getNodeValue();
                danish = doc.getElementsByTagName("language").item(10)
                .getAttributes().getNamedItem("danish").getNodeValue();
                russian = doc.getElementsByTagName("language")
                .item(11).getAttributes().getNamedItem(
                        "russian").getNodeValue();
                ukrainian = doc.getElementsByTagName("language")
                .item(12).getAttributes().getNamedItem(
                        "ukrainian").getNodeValue();
                polish = doc.getElementsByTagName("language").item(13)
                .getAttributes().getNamedItem("polish")
                .getNodeValue();
                ...
                .getAttributes().getNamedItem("japanese").getNodeValue();
                korean = doc.getElementsByTagName("language").item(16)
                .getAttributes().getNamedItem("korean")
                .getNodeValue();
                ...
                .getAttributes().getNamedItem("arabic")
                .getNodeValue();
                ...
                .getNodeValue();
                persian = doc.getElementsByTagName("language")
                .item(22).getAttributes().getNamedItem("persian")
                .getNodeValue();
                esperanto = doc.getElementsByTagName("language")
                .item(23).getAttributes().getNamedItem("esperanto")
                .getNodeValue();                
