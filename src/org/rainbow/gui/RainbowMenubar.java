...
public class RainbowMenubar {
    ...
    private JMenuItem mniSave, mniModify, mniExportHTML, mniImportFCS;
    ...
    */
    ...
    private JMenu createFileMenu() {
        ...
        mniModify = new JMenuItem(Language
                .getModifyConfiguration(),
        ...
        mniExportHTML = new JMenuItem(Language
                .getExportHTML(),
        ...
        mniImportFCS = new JMenuItem(Language.getOpenConfiguration() + " (fcs)",
				     IconUtilsRainbow.getGeneralIcon("html_16"));
        mniImportFCS.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                rainbow.importFCS();
            }
        });
        fileMenu.add(mniImportFCS);
    ...
    private JMenu createWindowMenu() {
        ...
        windowItems = new JCheckBoxMenuItem[rainbow.getViews().getNumberOfViews()];        
        ...
        windowItems[0] = new JCheckBoxMenuItem(Language
                .getGraphOfRunningProcesses(), IconUtilsRainbow
                .getPanelIcon("function"), true);
        ...
        windowItems[1] = new JCheckBoxMenuItem(Language
                .getGraphOfResourcesAssignment(), IconUtilsRainbow
                .getPanelIcon("shapegraph"), true);
    ...
    private JMenu createThemesMenu() {
        ...
        for (int i = 0; i < laf.length; i++) {
            JRadioButtonMenuItem item = new JRadioButtonMenuItem(laf[i] + " Look And Feel");
    ...
    private JMenu createHelpMenu() {
        ...
        mniHelp.addActionListener(new CSH.DisplayHelpFromSource(hb) {
		    ...
		    hs.setHomeID(helpId);
                    ...
                    System.out.println("Target " + helpId + " mistaked in createHelpMenu (BadIDException)");
                } catch (InvalidHelpSetContextException ex) {
                    System.out.println("Target " + helpId + " mistaked in createHelpMenu (InvalidHelpSetContextException)");                
                }
