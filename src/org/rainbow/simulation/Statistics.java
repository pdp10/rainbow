		...
		if (running != null) {
			procStat.add(new ProcessStatistics(running, executed));
                ...
                for (i = 0; i < ready.size(); i++) {
                    /*
                     * This test avoids to consider processes created during the simulation
                     * from policies with priority or multilevel. (See the method getReadyQueue() in 
                     * HPF.java, MF.java, PriorityRoundRobin.java .)
                     */
