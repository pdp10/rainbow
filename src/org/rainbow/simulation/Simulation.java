...
public class Simulation {
    ...
    /**
     * It returns the delay between a tick of simulation and its following. (The incremental step).
     *
     * @return delay.
     */
    public int getDelay() {
    ...
    /**
     * It sets the delay between a tick of
     * simulation and its following. (The incremental step)
     *
     * @param delay
     *            
     */
    ...
    public void statistics() {
        if (executingProcesses.size() == evolution.getDuration()) {
            ...
            rainbowViews.viewStatistics(new Statistics(now, executingProcesses));
        }
    }
